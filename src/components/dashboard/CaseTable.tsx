...
export function CaseTable({ cases = mockCases, statusFilter: initialStatusFilter, onCaseSelect }: CaseTableProps) {
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left p-3 text-sm font-semibold text-muted-foreground">Case Type</th>
            ...
            <tbody>
              {filteredAndSortedCases.map((case_) => (
                <tr 
                  key={case_.id}
                  className="border-b border-border hover:bg-dashboard-hover transition-colors cursor-pointer"
                ...
                >
                  ...
                  <td className="p-3 text-sm text-muted-foreground">{case_.caseType}</td>
                  <td className="p-3">
                  ...
                  <td className="p-3 text-sm font-medium">
                    {case_.actualPayout 
                      ? formatCurrency(case_.actualPayout)
                      : formatCurrency(case_.estimatedPayout || case_.aiPrediction.predictedPayout)
                    }
                  </td>
                  <td className="p-3">
                    <div className={cn(
